...
export default class QrScanner {
    ...
    static _loadImage(imageOrFileOrUrl) {
        if (imageOrFileOrUrl instanceof HTMLCanvasElement || imageOrFileOrUrl instanceof HTMLVideoElement // eslint-disable-next-line
            || window.ImageBitmap && imageOrFileOrUrl instanceof window.ImageBitmap // eslint-disable-next-line
...
var workerLink = (process.env.NODE_ENV === 'production' ? 'https://kino.linnuu.com/assets/qr-scanner-worker.min.js' : 'http://localhost:3000/assets/qr-worker.min.js');
QrScanner.DEFAULT_CANVAS_SIZE = 400;
QrScanner.WORKER_PATH = workerLink;
/** @preserve @asset(https://kino.linnuu.com/assets/qr-scanner-worker.min.js) */
